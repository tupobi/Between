package www.tupobi.top.between.service;
...
import www.tupobi.top.between.activity.AtyMain;
import www.tupobi.top.between.listener.DownloadListener;
import www.tupobi.top.between.thread.DownloadTask;
...
public class DownloadService extends Service {
    ...
    private void installApk() {
        File file = new File(Environment.getExternalStorageDirectory() + File.separator + "183" + File.separator + "Between.apk");
