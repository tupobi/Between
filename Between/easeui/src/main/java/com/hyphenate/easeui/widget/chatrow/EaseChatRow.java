...
//            }
            //
            if ("cjm520".equals(message.getFrom())) {
//                Toast.makeText(context, "from == " + message.getFrom(), Toast.LENGTH_SHORT).show();
                Glide.with(context).load(R.drawable.head_of_cjm).into(userAvatarView);
//                userAvatarView.setBackgroundResource(R.drawable.head);
            } else if ("lzj7800623".equals(message.getFrom())) {
                Glide.with(context).load(R.drawable.head_of_lzj).into(userAvatarView);
            }
        }
