...
//        getActivity().getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_UNSPECIFIED);
    ...
    protected void setUpView() {
        ...
        //
        if ("lzj7800623".equals(toChatUsername)) {
            //cjm
            titleBar.setTitle("李傻杰");
        } else if ("cjm520".equals(toChatUsername)) {
            //lzj
            titleBar.setTitle("陈嘉敏同学");
        } else {

        }
//        titleBar.setBackgroundColor(Color.parseColor("#8B8989"));
        titleBar.setBackgroundColor(Color.parseColor("#1A000000"));
        //26
//        titleBar.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                ToastUtil.showShort(view.getContext(), "点击头像");
//            }
//        });
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            // set title
